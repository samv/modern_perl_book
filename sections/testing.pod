...
=item * C<Test::Perl::Critic> is an example of a module which allows tests of the coding style of your code, not just the functionality, to help ensure consistency and hence, maintainability of your code.
